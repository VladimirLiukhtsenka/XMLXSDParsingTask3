...
import com.liukhtenko.xmlxsdparsing.parser.PeriodicalDOMBuilder;
...
//        try {
//            papers = DirectorOfBuilder.createPeriodical(new PeriodicalStAXBuilder(),"data/periodical.xml");
